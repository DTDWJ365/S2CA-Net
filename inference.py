...
def parse_args():
    ...
    parser.add_argument('--root', default="./dataest/BraTS2018/MICCAI_BraTS_2018_Data_Validation",
                            help='validation dataset path')
    parser.add_argument('--model', type=str, default='fuse',
                        help='network for training, support UNet and FuseUNet')
    parser.add_argument('-c', '--checkpoint', type=str, default="./checkpoints/BraTS2019/s2ca_net/ds_True/s2ca_net_Epoch_43_loss_0.627.pkl",help='model checkpoint used for breakpoint continuation')
